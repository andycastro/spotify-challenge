...
export const ArtistCardSkeleton: React.FC = () => {
  return (
    <div
      className="relative flex flex-col rounded-lg border border-[#1ed7601a] bg-[#121212] overflow-hidden shadow-[0_0_0_1px_#1ed76010] animate-pulse"
      aria-hidden="true"
    >
      <div className="w-full h-[456px] bg-neutral-800" />
